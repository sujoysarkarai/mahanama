...
from lingmess_token_level.util_original import set_seed
...
def main():
    ...
    # tokenizer = AutoTokenizer.from_pretrained("../pretrain_tokenizer/tokenizer/ByteLevelBPETokenizer/8000", use_fast=True,
    #                                           add_prefix_space=True, cache_dir=args.cache_dir)
    ...
    #     f.write(str(dataset[args.eval_split][0]))
    # return
    print("traing args - ")
    print(args)
