...
class Experiment:
    ...
    def __init__(self, config: DictConfig):
        ...
        print(self.best_model_path, " model path")
    ...
    def _load_data(self):
        ...
        print(len(raw_data_map[dataset_name]))
        # Tensorize data
        ...
        if self.eval_model:
            ...
            for split in ["train", "dev", "test"]:
                ...
                # if training:
                # print(f"train {split}- ")
                # print(len(raw_data_map[dataset][split]))
                # print(len(self.data_iter_map[split][dataset]))
    ...
    def train(self) -> None:
        ...
        log_score_dir = path.join(self.config.paths.model_dir, "log_score.txt")
        ...
        while True:
            ...
            with open(log_score_dir, 'a') as file:
                file.write("Steps done %d" % (self.train_info["global_steps"]))
                file.write("\n")
            ...
            for cur_document in tqdm(train_data):
