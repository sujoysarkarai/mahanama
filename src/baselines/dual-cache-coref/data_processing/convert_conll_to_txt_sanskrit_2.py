    ...
    with open(output_path, 'w') as outfile:
        for file_path in file_list:
            with open(file_path, 'r') as infile:
                ...
                while True:
                    lines = infile.readlines(1024)  # Read in chunks of 1KB
                    if not lines:
                        break
...
if __name__ == "__main__":
    ...
    main('../../final_data/conll_format/v3/', '../../coref_resources/data/sanskrit_mahabharat_2/conll', '../../final_data/conll_format/list_of_possible_test_subchapters.csv')
