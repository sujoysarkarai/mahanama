...
class BaseDocEncoder(nn.Module):
    def __init__(self, config: DictConfig):
        ...
        # tokenizer_folder = f"../pretrain_tokenizer/tokenizer/ByteLevelBPETokenizer/16000"
        # custom_tokenizer = LongformerTokenizerFast.from_pretrained(tokenizer_folder, use_fast=True)
        # self.tokenizer: PreTrainedTokenizerFast = custom_tokenizer
