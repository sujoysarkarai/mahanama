...
class Datasets:
    ...
    def get_aida_docs(
        ...
        with open('your_file_copy.txt', 'w') as fc:
                    ...
                    if include_spans:
                        ...
                        for span in line["spans"]:
                            ...
                            if len(titles) == 0:
                                ...
                                titles = [
                                    uri.replace("http://null/notInWiki/", "")
                                    for uri in span["uris"]
                                    if "http://null/notInWiki/" in uri
                                ]
                                # print(text[span["start"]: span["start"] + span["length"]])
                                # print(titles)
                                if len(titles) == 0:
                                    continue
                            ...
                            if include_gold_label:
                                ...
                                p_line = (span["start"], span["length"], text[span["start"]: span["start"] + span["length"]], Entity(wikidata_entity_id=qcode, wikipedia_entity_title=title))
                                fc.write(f"{p_line}\n")
                            else:
                                spans.append(
                                    Span(
