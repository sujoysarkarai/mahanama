...
class CandidateGeneratorExactMatch(CandidateGenerator):
    ...
    def get_candidates(
        ...
        # # print(type(self.pem))
        # print(dir(self.pem))
        # # print(self.pem.get(0))
        # print(self.pem.values())
        # print(self.pem.keys())
        # print(self.pem.items())
        # print(self.pem['superhero'])


        # with open("pem.txt", "w") as f:
        #     # try:
        #         # Fetch all keys
        #     # keys = self.pem.keys()
        #     # f.write(str(keys))
        ...
        #         value = self.pem[key]  # or self.pem[key]
        #         # Write the key-value pair in a readable format
        #         print(key)
        #         f.write(f"{key}: {value}\n")
        #     print("Data written to pem.txt successfully!")
        ...
        surface_form_norm = normalize_surface_form(surface_form, remove_the=True) # need to remove .lower()
        # print(surface_form)
        # print(surface_form_norm)
        # exit()
        ...
        try: 
            direct_cands = list(direct_cands.items())
        except:
            pass
    ...
    def add_candidates_to_spans(
        ...
        for span in spans:
            ...
            # print(person_coreference)

        with open("pem2.txt", "w") as f:
            for span in spans:
                t = [span.text, span.gold_entity, span.candidate_entities, span.doc_id, span.predicted_entity, span.top_k_predicted_entities]
                f.write(str(t))
        # exit()
